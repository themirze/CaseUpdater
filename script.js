        ...
        <div id="noteMailContainer" style="display: flex; justify-content:space-between;">
          <div id="noteContainer">
            ...
            <div id="inactiveContent" style="display: none; margin-left: 20px;">
              ...
              <a href="#" id="inNotReady2">
                IN - Not Ready (TechnicalBase)
              </a><br /><br />
          ...
          <div id="mailContainer">
            ...
            <div id="tagShoppingContent" style="display: none; margin-left: 20px;">
              ...
              <div id="firstResponseContent" style="display: none; margin-left: 20px;">
                <a href="#" id="firstResponse">First Response Email for New Tickets</a
                ><br /><br />
                <a href="#" id="firstResponseDFA">
                  First Response Email for New Tickets DFA
                </a><br /><br />
              </div>
              <div>
                <h3 style="display: inline;">AS - Reschedule</h3>
                <button
                  id="rescheduleButtonTS"
                  style="background: none; border: none; cursor: pointer; font-size: 1.2em;"
                >
                  ⬇
                </button>
              ...
              <div
                id="inactiveContentTS"
                style="display: none; margin-left: 20px;"
              >
                <a href="#" id="inRescLimExc">IN - Reschedule Limit Exceeded</a
                ><br /><br />
                ...
                <a href="#" id="inOssUtt">IN - Out of Scope - Unable to Transfer</a
                ><br /><br />
                <a href="#" id="inOssEts">IN - Out of Scope - Email to Seller</a
                ><br /><br />
              ...
              <div id="impContentTs" style="display: none; margin-left: 20px;">
                ...
                <a href="#" id="impVnnc">SO - Verified No Recent Conversion</a
                ><br /><br />
            ...
            <div id="LeadGenContent" style="display: none; margin-left: 20px;">
              ...
              <div id="LawaitingContentTs" style="display: none; margin-left: 20px;">
                ...
                <a href="#" id="Lmlag">NI - Modifying leadform to accept GCLID</a
                ><br /><br />
              ...
              >
                ...
                <a href="#" id="linOssRtit">
                  IN - Out of Scope - Rerouted to Internal Team
                </a><br /><br />
                <a href="#" id="linOssUtt">IN - Out of Scope - Unable to Transfer</a
                ><br /><br />
                <a href="#" id="linOssEts">IN - Out of Scope - Email to Seller</a
                ><br /><br />
